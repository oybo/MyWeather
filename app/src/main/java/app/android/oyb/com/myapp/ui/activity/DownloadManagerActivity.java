...
import app.android.oyb.com.myapp.widget.NumberProgressBar;
...
public class DownloadManagerActivity extends BaseActivity implements View.OnClickListener, ExecutorWithListener.OnAllTaskEndListener {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ImageLoadManager.setImage(DownloadManagerActivity.this, "http://inthecheesefactory.com/uploads/source/nestedfragment/fragments.png", null);
