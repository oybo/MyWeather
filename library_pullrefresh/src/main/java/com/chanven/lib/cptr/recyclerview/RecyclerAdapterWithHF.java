...
public class RecyclerAdapterWithHF extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public RecyclerViewHolder onCreateViewHolderHF(ViewGroup viewGroup, int type) {
        return mAdapter.onCreateViewHolder(viewGroup, type);
    }

    @Override
    public final RecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
        // if our position is one of our items (this comes from
        // getItemViewType(int position) below)
        if (type != TYPE_HEADER && type != TYPE_FOOTER) {
            RecyclerViewHolder vh = onCreateViewHolderHF(viewGroup, type);
            return vh;
            ...
            return new HeaderFooterViewHolder(mContext, frameLayout);
        }
    }

    @Override
    public final void onBindViewHolder(final RecyclerViewHolder vh, int position) {
    ...
    public void onBindViewHolderHF(RecyclerViewHolder vh, int position) {
    ...
    public static class HeaderFooterViewHolder extends RecyclerViewHolder {
        FrameLayout base;


        public HeaderFooterViewHolder(Context ctx, View itemView) {
            super(ctx, itemView);
    ...
    public RecyclerAdapterWithHF(Context context, RecyclerView.Adapter<RecyclerViewHolder> adapter) {
        super();
